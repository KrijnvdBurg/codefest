            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        System.out.println("DB: " + id + username + role_id + firstname + lastname + department_id + ptf_id);

                        db.addUser(id, username, role_id, firstname, lastname, department_id, ptf_id);
